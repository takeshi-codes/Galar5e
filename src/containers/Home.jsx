          ...
          <Card className={classes.label}>
            <CardContent>
              <Typography variant="body1" gutterBottom className={classes.label}>
                Galar5e is still under construction! Thank you for your patience while we
                are making these changes. Currently Galar5e is only available on desktop,
                we are working on the mobile site now. To see our progress, click the
                button below!
                <Button
                  variant="contained"
                  color="primary"
